...
Here are some projects I have built independently:

- **Job Board Site:** Platform for posting and applying to jobs  
- **E-commerce Store:** Full shopping site with authentication and payment integration  
- **Chat Application:** Real-time messaging app using WebSockets  
- **APIs:** Custom APIs for automation and integrations  

I handle both frontend and backend tasks. I focus on building **fast, secure, and scalable applications**.

---

## Learning & Goals

- Improve AI and NLP integrations in applications  
- Optimize full-stack performance and scalability  
- Explore modern web frameworks and best practices  
